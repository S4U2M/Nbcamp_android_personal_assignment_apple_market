...
object SellerDB {
    ...
    val sellerModelDB = mutableListOf<SellerModel>()
    ...
    init {
        ...
        sellerModelDB.add(
            SellerModel(
                7, R.drawable.sample7,
                "울산 동해오션뷰 60평 복층 펜트하우스 1일 숙박권 펜션 힐링 숙소 별장",
                "울산 동해바다뷰 60평 복층 펜트하우스 1일 숙박권\n" +
                        "(에어컨이 없기에 낮은 가격으로 변경했으며 8월 초 가장 더운 날 다녀가신 분 경우 시원했다고 잘 지내다 가셨습니다)\n\n" +
                        "1. 인원: 6명 기준입니다. 1인 10,000원 추가 요금\n\n" +
        ...
        sellerModelDB.add(SellerModel(
            8,R.drawable.sample8,
            "샤넬 탑핸들 가방",
        ...
        sellerModelDB.add(SellerModel(
            9,R.drawable.sample9,
            "4행정 엔진분무기 판매합니다.",
            "3년 전에 사서 한 번 사용하고 그대로 둔 상태입니다. 요즘 사용은 안 해봤습니다. 그래서 저렴하게 내 놓습니다. 중고라 반품은 어렵습니다.",
            "알뜰한",
            30000,
            "원주시 명륜2동",
            7, 28
